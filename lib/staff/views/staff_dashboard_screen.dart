...
class StaffDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<int> getTotalCompleted() async{
      QuerySnapshot querySnapshot = await _firestore.collection('referralDID').where("status", isEqualTo: "Completed").where('staffAttending',isEqualTo: _auth.currentUser!.uid).get();
      return querySnapshot.docs.length;
    }

    Future<int> getTotalNew() async{
      QuerySnapshot querySnapshot = await _firestore.collection('referralDID').where('status',isEqualTo: 'Pending').where('staffAttending',isEqualTo: 'empty').get();
      return querySnapshot.docs.length;
    }

    Future<int> getTotalReject() async{
      QuerySnapshot querySnapshot = await _firestore.collection('referralDID').where('status',isEqualTo: 'Reject').where('staffAttending',isEqualTo: _auth.currentUser!.uid).get();
      return querySnapshot.docs.length;
    }
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        String staffName = snapshot.data!['fullName'] ?? 'No staff name';
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => StaffAccountScreen()));
                        },
                        child: ListTile(
                            leading: Icon(
                              Icons.settings,
