...
class _ReferralRequestScreenState extends State<ReferralRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
        ...
        .where("staffAttending", isEqualTo: "empty")
                        ...
                        onPressed: () async {
                          ...
                          if (confirm) {
                            _firestore
                                ...
                                .doc(referralData['referralId'])
                                .update({
                              'staffAttending': _auth.currentUser!.uid,
                              'status': 'Approved'
                            });
                              ...
                              'message': {
                                ...
                                'html': '''
                                          <div style="font-family: Arial, sans-serif; color: #333;">
                                            ...
                                            <p><strong>Patient IC:</strong> ${referralData['patientIdentity']}</p>
                                            ...
                                            <p style="padding: 10px; background-color: #f9f9f9; border-radius: 5px;">
                                              ...
                                              ${referralData['didOption']?.replaceAll('\n', '<br/>')}<br/>
                                              ${referralData['remarks']?.replaceAll('\n', '<br/>')}<br/>
                                            </p>
                                            <p>
