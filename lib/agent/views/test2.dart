            ...
            child: Column(
              children: [
                ...
                Container(decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                    color: Colors.white),
                  child: _buildPatientInfoSection(data),
                ),
                Divider(thickness: 2, color: Colors.grey.shade200),
                Container(decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                    color: Colors.white),
                  child: _buildInsuranceInfoSection(data),
                ),
                Divider(thickness: 2, color: Colors.grey.shade200),
                Container(decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                    color: Colors.white),
                  child: _buildReferralReasonSection(data),
                ),
                Container(decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                ...
                child: Column(
                  ...
                  children: [
                    Text('Age',
                        style: TextStyle(
                            fontSize: 10, color: Colors.grey.shade800)),
                    Text('${data['patientAge']} Years Old',
                        style: GoogleFonts.roboto(
                            fontSize: 13, fontWeight: FontWeight.bold)),
                    SizedBox(
                      height: 10,
                ...
                if (validFiles.isNotEmpty) {
                  setState(() async {
                    ...
                    try {
                      ...
                      DocumentSnapshot patientDoc = await patient.doc(widget.referralId).get();
                      List<String> existingFiles = List<String>.from(patientDoc['fileUrlList'] ?? []);
                      ...
                      List<String> updatedFiles = [...existingFiles, ...newFiles];

                      // Update the database
                      await patient.doc(widget.referralId).update({'fileUrlList': updatedFiles});
