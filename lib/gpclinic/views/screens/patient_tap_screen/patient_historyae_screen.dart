...
class PatientHistoryAeScreen extends StatefulWidget {
  const PatientHistoryAeScreen({super.key});

  @override
  State<PatientHistoryAeScreen> createState() => _PatientHistoryScreenState();
}

class _PatientHistoryScreenState extends State<PatientHistoryAeScreen> {
  @override
