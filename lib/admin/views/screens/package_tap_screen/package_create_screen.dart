...
class _PackageCreateScreenState extends State<PackageCreateScreen> {
  ...
  Future<Uint8List> compressImage(Uint8List imageBytes) async {
    ...
    img.Image resized = img.copyResize(image, width: 800); // Resize to a smaller width
    return Uint8List.fromList(img.encodeJpg(resized, quality: 85)); // Adjust quality to compress
  }
  ...
  selectImage() async {
    ...
    if (im != null) {
      ...
      Uint8List compressedImage = await compressImage(im);
      setState(() {
            ...
            child: Column(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: Text('Add Package', style: TextStyle(color: Colors.white)),
                ),
              ],
            ),
          ),
